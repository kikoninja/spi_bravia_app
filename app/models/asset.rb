class Asset < ActiveRecord::Base
  ...
  attr_accessible :feed, :feed_id, :asset_type, :content_id, :description, :duration, :pay_content, :title, :video_id, :categories, :category_ids, :thumbnail_url, :live, :source_url, :rating, :package_id
